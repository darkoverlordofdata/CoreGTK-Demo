...
+ (NSString *)presentOpenDialog
{
	...
	CGTKFileChooserDialog *dialog = [[CGTKFileChooserDialog alloc] initWithTitle:@"Open File" andParent:nil andAction:GTK_FILE_CHOOSER_ACTION_OPEN andButtonTextResponseDictionary:buttonTextDict];
	...
	if(result == GTK_RESPONSE_ACCEPT)
	{
		...
		gText = gtk_file_chooser_get_filename ((GtkFileChooser *)[dialog FILECHOOSERDIALOG]);
...
+ ( NSString *)presentSaveDialog
{
	...
	// Set settings
	gtk_file_chooser_set_do_overwrite_confirmation ((GtkFileChooser *)[dialog FILECHOOSERDIALOG], TRUE);
	gtk_file_chooser_set_current_name((GtkFileChooser *)[dialog FILECHOOSERDIALOG], "Untitled document");
